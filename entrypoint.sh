...
CRON_ENV="DD_ENV=${DD_ENV:-prod} DD_SERVICE=${DD_SERVICE:-devtoolscrape} DD_VERSION=${DD_VERSION:-1.1} DD_AGENT_HOST=${DD_AGENT_HOST:-dd-agent} DD_TRACE_ENABLED=${DD_TRACE_ENABLED:-true} DD_APM_ENABLED=${DD_APM_ENABLED:-true} DD_RUNTIME_METRICS_ENABLED=${DD_RUNTIME_METRICS_ENABLED:-true} DD_DOGSTATSD_URL=${DD_DOGSTATSD_URL:-udp://dd-agent:8125} DD_APPSEC_ENABLED=${DD_APPSEC_ENABLED:-true} DD_IAST_ENABLED=${DD_IAST_ENABLED:-true} DD_IAST_REQUEST_SAMPLING=${DD_IAST_REQUEST_SAMPLING:-100} DD_LLMOBS_ENABLED=${DD_LLMOBS_ENABLED:-1} DD_LLMOBS_ML_APP=${DD_LLMOBS_ML_APP:-devtoolscrape} DD_CODE_ORIGIN_FOR_SPANS_ENABLED=${DD_CODE_ORIGIN_FOR_SPANS_ENABLED:-true} DD_EXCEPTION_REPLAY_ENABLED=${DD_EXCEPTION_REPLAY_ENABLED:-true}"
